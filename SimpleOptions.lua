...
do
	BadBoyIgnoreConfigTitle:SetText("BadBoy_Ignore @project-version@") --packager magic, replaced with tag version
	local infoTbl = {}
	...
	BadBoy_IgnoreAddText:SetText("Add name")
	...
	BadBoy_IgnoreRemoveText:SetText("Remove name")
